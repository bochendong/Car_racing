...
class CarRacing(gym.Env, EzPickle):
    ...
    def __init__(self, verbose=1, color = 'g'):
    ...
    def render_road(self):
        ...
        if (self.color == 'g'):
            ...
            colors = [0.5, 0.7, 0.6, 1.0] * 4
        elif (self.color == 'b1'):
            colors = [0.8, 0.4, 0.4, 1.0] * 4
        elif (self.color == 'b2'):
            colors = [0.4, 0.4, 0.8, 1.0] * 4
        elif (self.color == 'b3'):
        ...
        if (self.color == 'g'):
            ...
            colors.extend([0.4, 0.6, 0.7, 1.0] * 4 * 20 * 20)
        elif (self.color == 'c2'):
            colors.extend([0.5, 0.8, 0.6, 1.0] * 4 * 20 * 20)
        elif (self.color == 'b1'):
